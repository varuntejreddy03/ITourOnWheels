...
const images = [
  // Qutub Minar tall portrait — for card/grid
  { file: "dest-delhi-monument.webp", id: "1567157577867-05ccb1388e66", w: 1200, h: 1600 },
  // Qutub Minar wide landscape — for detail page hero
  { file: "dest-delhi.webp",          id: "1567157577867-05ccb1388e66", w: 1920, h: 1080 },
];
